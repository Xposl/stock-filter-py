...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Authenticate = channel.unary_unary(
                '/shanmu.auth.AuthService/Authenticate',
        ...
        self.ValidateToken = channel.unary_unary(
                '/shanmu.auth.AuthService/ValidateToken',
        ...
        self.CheckPermission = channel.unary_unary(
                '/shanmu.auth.AuthService/CheckPermission',
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'shanmu.auth.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('shanmu.auth.AuthService', rpc_method_handlers)
