...
from .xueqiu_company import (
    ...
    XueqiuUsCompany,
    XueqiuZhCompany,
    xueqiu_hk_company_from_dict,
    xueqiu_us_company_from_dict,
    xueqiu_zh_company_from_dict,
)
...
class XueqiuStockClient(XueqiuBaseClient):
    ...
    def get_stock_quote(self, code: str) -> Optional[XueqiuStockQuote]:
        ...
        try:
            ...
            if (
                ...
                or "quote" not in json_data["data"]
                or json_data["data"]["quote"] is None
            ):
                return None
    ...
    def get_zh_stock_company(self, code: str) -> Optional[XueqiuZhCompany]:
        ...
        try:
            symbol = self._get_symbol(code)
            url = (
                f"https://stock.xueqiu.com/v5/stock/f10/cn/company.json?symbol={symbol}"
            )
            ...
            if (
                "data" not in json_data
                or json_data["data"] is None
                or "company" not in json_data["data"]
                or json_data["data"]["company"] is None
            ):
                return None
    ...
    def get_hk_stock_company(self, code: str) -> Optional[XueqiuHkCompany]:
        ...
        try:
            symbol = self._get_symbol(code)
            url = (
                f"https://stock.xueqiu.com/v5/stock/f10/hk/company.json?symbol={symbol}"
            )
    ...
    def get_us_stock_company(self, code: str) -> Optional[XueqiuUsCompany]:
        ...
        try:
            symbol = self._get_symbol(code)
            url = (
                f"https://stock.xueqiu.com/v5/stock/f10/us/company.json?symbol={symbol}"
            )
    ...
    async def get_stock_quote_async(self, code: str) -> Optional[XueqiuStockQuote]:
        ...
        try:
            ...
            if (
                ...
                or "quote" not in response_data["data"]
                or response_data["data"]["quote"] is None
            ):
                return None
    ...
    async def get_zh_stock_company_async(self, code: str) -> Optional[XueqiuZhCompany]:
        ...
        try:
            ...
            if (
                "data" not in response_data
                or response_data["data"] is None
                or "company" not in response_data["data"]
                or response_data["data"]["company"] is None
            ):
                return None
