...
class Settings(BaseSettings):
    ...
    # 应用程序设置
    app_name: str = "Ticker Trend Service"
    ...
    nacos_namespace: str = "ticket-trend-service"
    nacos_group: str = "DEFAULT_GROUP"
    nacos_username: str = "nacos"
    nacos_password: str = "nacos"
    nacos_data_id: str = "ticket-trend-service-config.yaml"

    # 服务注册配置 (仅在nacos_enabled时使用)
    service_name: str = "ticket-trend-service"
    ...
    pyppeteer_chromium_path: str = "/Chromium"
    pyppeteer_home: str = "/pyppeteer"
