...
class TestDevelopmentHelpers:
    ...
    def test_import_paths(self):
        ...
        try:
            # 测试核心模块导入
            from core.models.news_article import NewsArticle  # noqa: F401
            from core.models.news_source import NewsSource  # noqa: F401
            from core.service.news_article_repository import (
                NewsArticleRepository,  # noqa: F401
            )
            from core.service.news_source_repository import (
                NewsSourceRepository,  # noqa: F401
            )

            print("核心模块导入成功")

            # 测试API模块导入
            from api.api import app  # noqa: F401
            print("API模块导入成功")
