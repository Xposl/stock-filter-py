...
class XueqiuNewsClient(XueqiuBaseClient):
    ...
    async def fetch_timeline_data(self, news_source: NewsSource) -> List[Dict[str, Any]]:
        """
        抓取雪球时间线数据
    ...
    async def _parse_timeline_item(self, item: Dict, news_source: NewsSource) -> Optional[Dict[str, Any]]:
        """
        解析雪球条目
    ...
    def _calculate_importance(self, item: Dict) -> float:
        ...
        try:
            ...
            # 计算总分
            total_score = (retweet_count * retweet_weight + 
