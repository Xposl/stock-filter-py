...
class NewsScheduler:
    ...
    async def _fetch_news_job(self):
        ...
        try:
            ...
            logger.info(f"定时新闻抓取完成: {success_sources}个源成功, {error_sources}个源失败, 共获取{total_articles}篇文章")
    ...
    async def _fetch_morning_news_job(self):
        ...
        try:
            ...
            logger.info(f"晨间新闻抓取完成: {success_sources}个源成功, {error_sources}个源失败, 共获取{total_articles}篇文章")
    ...
    async def _fetch_evening_news_job(self):
        ...
        try:
            ...
            logger.info(f"收盘新闻抓取完成: {success_sources}个源成功, {error_sources}个源失败, 共获取{total_articles}篇文章")
    ...
    async def trigger_manual_fetch(self, source_ids: Optional[list] = None) -> Dict[str, Any]:
        """手动触发新闻抓取"""
        try:
            ...
            logger.info(f"手动新闻抓取完成: {success_sources}个源成功, {error_sources}个源失败, 共获取{total_articles}篇文章")
