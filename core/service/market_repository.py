...
from core.models.market import Market, MarketCreate, MarketUpdate, market_to_dict, dict_to_market
...
class MarketRepository:
    ...
    def create(self, market_data: Union[MarketCreate, Dict[str, Any]]) -> Optional[Market]:
        """
        创建新市场
    ...
    def update(self, market_id: int, update_data: Union[MarketUpdate, Dict[str, Any]]) -> Optional[Market]:
        """
        更新市场信息
