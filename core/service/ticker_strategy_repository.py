...
class TickerStrategyRepository:
    ...
    def get_item_by_ticker_id_and_strategy_key(self, ticker_id: int, strategy_key: str, kl_type: str) -> Optional[TickerStrategyModel]:
    ...
    def update_item(self, ticker_id: int, strategy_key: str, kl_type: str, time_key: str, entity: Dict[str, Any]) -> None:
        ...
        try:
            # 检查是否存在该记录
            existing_item = self.get_item_by_ticker_id_and_strategy_key(ticker_id, strategy_key, kl_type)
