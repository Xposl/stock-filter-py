...
from core.models.ticker_valuation import (
    TickerValuation as TickerValuationModel,
...
class TickerValuationRepository:
    ...
    def get_item_by_ticker_id_and_key(self, ticker_id: int, valuation_key: str) -> Optional[TickerValuationModel]:
        """根据股票ID和估值键获取估值记录
    ...
    def update_item(self, ticker_id: int, valuation_key: str, time_key: str, entity: Dict[str, Any]) -> None:
        """更新或创建估值记录
