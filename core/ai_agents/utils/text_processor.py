...
class TextCleaner:
    ...
    def __init__(self):
        ...
        # 停用词
        self.stop_words = set([
            "的", "是", "在", "了", "和", "有", "为", "与", "等", "及", "中", "上", "下", 
            "将", "由", "对", "从", "以", "到", "于", "按", "向", "往", "所", "但", "而",
            "这", "那", "其", "该", "此", "每", "各", "都", "也", "还", "就", "都", "又",
            "更", "很", "非常", "特别", "相当", "比较", "较", "更加", "十分", "极其",
            "他", "她", "它", "我", "你", "您", "咱", "大家", "人们", "自己"
        ])
...
class KeywordExtractor:
    ...
    def __init__(self):
        ...
        self.financial_weights = {
            "股票": 2.0, "股价": 2.0, "股市": 2.0, "上市": 1.8, "投资": 2.0,
            "收益": 1.8, "盈利": 2.0, "亏损": 2.0, "业绩": 1.8, "财报": 1.8,
            "涨": 2.5, "跌": 2.5, "暴涨": 3.0, "暴跌": 3.0, "突破": 2.2,
            "政策": 1.8, "监管": 1.8, "银行": 1.5, "基金": 1.5, "证券": 1.5,
            "市场": 1.5, "经济": 1.5, "金融": 1.5, "资本": 1.5, "融资": 1.8,
            "并购": 2.0, "重组": 2.0, "合作": 1.5, "协议": 1.5, "合同": 1.5
        }
...
class EntityExtractor:
            ...
            for pattern in patterns:
                ...
                for match in matches:
                    ...
                    if confidence >= 0.3:  # 置信度阈值
                        entities[entity_type].append(EntityResult(
                            entity=entity_text,
    ...
    def _deduplicate_entities(self, entities: List[EntityResult]) -> List[EntityResult]:
        ...
        for group in entity_groups.values():
            ...
            best_entity.positions = sorted(list(set(all_positions)))
...
class TextAnalyzer:
    ...
    def _count_financial_terms(self, text: str) -> int:
        """统计金融术语数量"""
        financial_terms = [
            "股票", "股价", "股市", "上市", "投资", "收益", "盈利", "亏损", "业绩", 
            "财报", "涨", "跌", "暴涨", "暴跌", "突破", "政策", "监管", "银行", 
            "基金", "证券", "市场", "经济", "金融", "资本", "融资", "并购", "重组"
        ]
    ...
    def _generate_text_summary(
        ...
        return {
            ...
            "text_type": text_type,
            "complexity_level": "高" if features.complexity_score > 7 else "中" if features.complexity_score > 4 else "低",
            "financial_relevance": "高" if features.financial_terms_count > 10 else "中" if features.financial_terms_count > 3 else "低"
        }
