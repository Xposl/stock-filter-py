...
class NewsAnalysisFlow:
    ...
    async def analyze_news_with_article_async(self, article: NewsArticle) -> EnhancedNewsAnalysisResult:
        ...
        try:
            ...
            action = self.classifier_node.post(shared_store, classifier_prep, classifier_result)
            ...
            if action in ["analyze_stocks", "analyze_industry"]:
                ...
                action = self.stock_analyzer_node.post(shared_store, stock_prep, stock_result)
...
# 🔄 便捷函数 - 保持与原版接口一致
def analyze_single_news(news_content: str, news_id: str = None, test_mode: bool = False) -> EnhancedNewsAnalysisResult:
    """
