...
class SiliconFlowClient:
    ...
    def __init__(self, 
        ...
        self.base_url = base_url or os.getenv('SILICON_FLOW_BASE_URL', 'https://api.siliconflow.cn/v1')
        self.model = model
    ...
    async def chat_completions(self, 
        ...
        try:
            ...
            logger.info(f"硅基流动API请求: model={request_data['model']}, messages_count={len(messages)}")
    ...
    async def analyze_news(self, 
                          news_content: str, 
                          analysis_type: str = "sentiment") -> SiliconFlowResponse:
        """
        新闻分析专用接口
