...
class StockDataFactory:
    ...
    def _select_best_provider(self, operation: str, market: StockMarket = None) -> Optional[StockDataProvider]:
        """
        选择最佳的数据提供者
        ...
        if market:
            market_providers = [p for p in available_providers if market in p.get_supported_markets()]
            if market_providers:
    ...
    def get_stock_info(self, symbol: str, market: StockMarket = None, 
                      provider_name: str = None) -> StockDataResponse:
        """
        获取股票基本信息
    ...
    def get_stock_history(self, symbol: str, 
        ...
        if provider_name:
            ...
            if provider and provider.is_available:
                try:
                    data = provider.get_stock_history(symbol, start_date, end_date, period, market)
                    return StockDataResponse(data, provider.name, data is not None)
                except Exception as e:
    ...
    def get_company_info(self, symbol: str, market: StockMarket = None, 
                        provider_name: str = None) -> StockDataResponse:
        """
        获取公司详细信息
    ...
    def search_stocks(self, keyword: str, market: StockMarket = None, 
                     limit: int = 10, provider_name: str = None) -> StockDataResponse:
        """
        搜索股票
    ...
    def get_provider_status(self) -> Dict[str, Dict[str, Any]]:
        ...
        for provider in self._providers:
            status[provider.name] = {
                ...
                'supported_markets': [market.value for market in provider.get_supported_markets()]
            }
        return status
...
# 便捷函数
def get_stock_info(symbol: str, market: StockMarket = None, provider_name: str = None) -> StockDataResponse:
    """获取股票基本信息的便捷函数"""
    return get_stock_data_factory().get_stock_info(symbol, market, provider_name)


def get_stock_quote(symbol: str, market: StockMarket = None, provider_name: str = None) -> StockDataResponse:
    """获取股票实时行情的便捷函数"""
...
def get_stock_history(symbol: str, 
                     ...
                     provider_name: str = None) -> StockDataResponse:
    """获取股票历史数据的便捷函数"""
    return get_stock_data_factory().get_stock_history(symbol, start_date, end_date, period, market, provider_name)


def get_company_info(symbol: str, market: StockMarket = None, provider_name: str = None) -> StockDataResponse:
    """获取公司详细信息的便捷函数"""
